        ...
        <el-form label-width="120px">
            ...
            <el-form-item label="课程类别">
                ...
                <el-select v-model="courseInfo.subjectParentId" placeholder="请选择" @change="subjectChanged">
                    <el-option v-for="subject in subjectList" :key="subject.id" :label="subject.title"
                        :value="subject.id" />
                </el-select>
                <!-- 二级分类 -->
            ...
            <el-form-item label="课程封面">
                <el-upload :show-file-list="false" :on-success="handleCoverSuccess" :before-upload="beforeCoverUpload"
                    :on-error="handleCoverError" :action="BASE_API + '/admin/vod/file/upload'" class="cover-uploader">
    ...
    methods: {
        ...
        updateData () {
            courseApi.updateCourseInfoById(this.courseInfo).then(response => {
                console.log("即将被更新的课程详情：" + this.courseInfo)
